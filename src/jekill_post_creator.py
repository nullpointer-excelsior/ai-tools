...
CORRECT_TEXT_PROMPT = """
Corrige la gramatica y la ortografia del siguiente artículo encerrado en triple acento grave, el cual está en formato markdown. Ignora los bloques de código, pero estos deben estar incluidos en el artículo final.
```{content}```
"""
