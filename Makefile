...
paste-summarize:
	export OPENAI_API_KEY="$(OPENAI_API_KEY)"; pbpaste | python src/summarize.py summarize | jq

summarize:
	export OPENAI_API_KEY="$(OPENAI_API_KEY)";python src/summarize.py summarize "$(t)" | jq
